...
def seed_database():
    ...
    with app.app_context():
        ...
        p2 = Product(title='Wireless Headphones', description='Noise-cancelling over-ear headphones with 40h battery.', price=199.99, image_file='placeholder.png', category_id=c1.id)
        p3 = Product(title='Cotton T-Shirt', description='100% Cotton breathable everyday T-shirt.', price=19.99, image_file='placeholder.png', category_id=c2.id)
        p4 = Product(title='Denim Jeans', description='Classic fit denim jeans, rugged and stylish.', price=49.99, image_file='placeholder.png', category_id=c2.id)
        p5 = Product(title='Coffee Maker', description='Programmable drip coffee maker for perfect mornings.', price=89.99, image_file='placeholder.png', category_id=c3.id)
        p6 = Product(title='Blender', description='High-power blender for smoothies and shakes.', price=59.99, image_file='placeholder.png', category_id=c3.id)
